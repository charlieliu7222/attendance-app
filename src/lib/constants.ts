// 第一個 Google Sheet（出席點名系統）
export const API_URL =
  'https://script.google.com/macros/s/AKfycbwI6S13GjlcHPVdcxCPaEOAsQCEtSBYLFo9V3-lhL8IDIlXQj6g-BAgNiLWJOzSdZdF/exec'
...
export const CACHE_PREFIX = 'att_'
